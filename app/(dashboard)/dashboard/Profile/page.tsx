...
// get the data from localStorage for user
  ...
  <Loading/>
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-zinc-800 dark:text-white py-8 px-4 sm:px-6 lg:px-8 transition-colors">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-800 shadow-lg rounded-xl overflow-hidden">
            {/* Profile Header */}
            <div className="px-6 py-8 bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800">
            ...
            <div className="divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <div className="px-6 py-4 grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="md:col-span-2">
                  <span className="text-gray-800 dark:text-gray-200">{formattedDates.updatedAt}</span>
                </div>
              </div>
            </div>
          </div>
